...
public class gui_user_02 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj.equals(btnSend)) {
			try {
				Pub_Redis.publisher("User_02: " + txtContent.getText() + "\n");
